...
OutFile "Release\MatroskaProp.exe"
...
DirText "This will install the MatroskaProp on your computer. Choose a directory"
...
Section "Matroska Shell Extension"
  ...
  ;RegDLL "$INSTDIR\MatroskaProp.dll" "ConfigureOptions"
   ...
   CreateShortCut "$SMPROGRAMS\Matroska Shell Extension\CheckUsage.lnk" "$INSTDIR\CheckUsage.exe" "" "$INSTDIR\CheckUsage.exe" 0
